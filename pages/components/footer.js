...
export default function Footer (){
    ...
    return (
      <div className={styles.mainDiv}>
        ...
        <Row>
          <Col className={styles.innerContent}><svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-headset" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M6.5 14a1 1 0 0 1 1-1h1a1 1 0 1 1 0 2h-1a1 1 0 0 1-1-1z"/>
          ...
          <Col className={styles.innerContent}>Copy Rights? Don't worry about them.</Col>
          <Col className={styles.innerContent}><svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-badge-8k" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <path fill-rule="evenodd" d="M14 3H2a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1zM2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H2z"/>
          ...
          <Col className={styles.innerContent}><svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-battery-charging" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
