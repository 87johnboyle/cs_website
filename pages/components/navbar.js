...
export default function NavBar({ children }) {
 ...
 {/* Input all your pages here for navbar, remember to add <NavBar /> to new page */}
        ...
        <svg width="2em" height="1em" viewBox="0 0 16 16" class="bi bi-people" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
      <Link  href="/components/projects"><a class="navbar-brand">Projects</a></Link>
      </li>
