...
type Mutation {
    createProject(name:String!, description:String!, frameworks:String!, namedLead:String!, channelName:String!): Project
...
const resolvers = {
    ...
    Mutation: {
        createProject: async (_, {name, description, frameworks, namedLead, channelName}, _c) => {
          return (await db("projects").insert({name, description, frameworks, namedLead, channelName}).returning("*"))[0]
        },
